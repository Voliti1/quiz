...
const rawMaterialPool = [
    { 
        q: "반도체의 3대 원재료 중 하나에 대한 설명이다. 이 설명에 해당하는 재료명은?\n\n'웨이퍼 : 반도체 물질로 만들어진 얇고 둥근 조각, 이 위에 집적회로를 만들어 넣게 된다. 현재 반도체 회사는 실리콘 웨이퍼를 주로 사용 하고 있으며, 직경 크기에 따라 4\", 5\", 6\", 8\", 12\"를 사용하고 있다.'", 
        a: ["웨이퍼 (Wafer)", "마스크 (Mask)", "리드 프레임 (Lead Frame)", "인쇄회로기판 (PCB)"], 
        c: 0, 
        r: "웨이퍼(Wafer)는 실리콘 등으로 만든 얇은 원판으로, 집적회로를 그 위에 그리는 반도체의 핵심 기판입니다." 
    },
    { 
        q: "반도체의 3대 원재료 중 하나에 대한 설명이다. 이 설명에 해당하는 재료명은?\n\n'마스크 : 웨이퍼 위에 만들어질 회로 패턴의 모양을 각 레이어 별로 유리판 위에 그려 놓은 것으로 Photo 공정시 Stepper(반도체 패턴 카메라)의 사진 건판으로 사용 된다.'", 
        a: ["웨이퍼 (Wafer)", "마스크 (Mask)", "리드 프레임 (Lead Frame)", "인쇄회로기판 (PCB)"], 
        c: 1, 
        r: "마스크(Mask)는 미세 회로 패턴이 유리판 위에 그려진 지판으로, 노광 공정 시 빛을 통과시키는 필터 역할을 합니다." 
    },
    { 
        q: "반도체의 3대 원재료 중 하나에 대한 설명이다. 이 설명에 해당하는 재료명은?\n\n'리드 프레임 : 보통 구리로 만들어진 구조물로서, 조립공정 시 칩이 이 위에 놓여지게 되며 가는 금선 으로 칩과 연결된다. 이렇게 하여 IC칩이 외부와 전기 신호를 주고 받게 된다.'", 
        a: ["웨이퍼 (Wafer)", "마스크 (Mask)", "리드 프레임 (Lead Frame)", "인쇄회로기판 (PCB)"], 
        c: 2, 
...
const gasPool = [
    { 
        q: "반도체 가스 종류 중 하나에 대한 설명이다. 이 설명에 해당하는 가스군은?\n\n'- 불연성 가스 : 가장 안전한 등급에 속하는 가스군으로 무색, 무취, 무미, 무 자극성 특징을 가지면 경고 특징이 없다. 유해성 (Hazards)으로는 고 압력으로 농축되어 있고, 저산소 농도(산소 19.5%)에 의한 질식성이 있으며 초저온상태이므로 주의해야 한다. 사용 예로는 Ar(아르곤), He(헬륨), N2(질소) 등이 있다.'", 
        a: ["불연성 가스", "가연성 가스", "독성 가스", "자연발화성 가스"], 
        c: 0, 
        r: "불연성 가스는 반응성이나 가연성이 없는 비교적 안전한 가스군으로 아르곤, 헬륨, 질소 등이 대표적입니다. 저산소 상태에 따른 질식 등에 주의해야 합니다." 
    },
    { 
        q: "반도체 가스 종류 중 하나에 대한 설명이다. 이 설명에 해당하는 가스군은?\n\n'- 가연성 가스 : 폭발범위 하한이 10% 이하 이 거나 폭발 범위가 20% 이상인 가스로써 공기 중에 누설되면 부피가 확산되어 피해 범위가 크다. 이미 기화되어 있어 작은 점화원으로도 쉽게 인화, 폭발된다. 유해성 (Hazards)으로는 화재 및 폭발성으로 가연성이 매우 높고 고 압력으로 농축되어 있고, 저 산소 농도(산소 19.5%)에 의한 질식성이 있다. 사용 예로는 H2 (수소), C2H2 (아세틸렌), CH4 (메탄)등이 있다.'", 
        a: ["가연성 가스", "산화성 가스", "독성 가스", "부식성 가스"], 
        c: 0, 
        r: "가연성 가스는 아주 작은 스파크에도 쉽게 불이 붙어 화재 및 폭발을 유발하며 수소, 아세틸렌, 메탄 등이 있습니다." 
    },
    { 
        q: "반도체 가스 종류 중 하나에 대한 설명이다. 이 설명에 해당하는 가스군은?\n\n'- 산화성 가스 : 연소를 촉진하거나 반응성을 증가시키는 가스로써 불난집에 부채질하는 가스로 볼수 있다. 유해성으로는 조연성으로 연소 및 반응성을 증가시키고 산소 과잉환경 조성하여 연소범위 넓어진다. 고 압력으로 주의해야 한다. 사용 예로는 호흡이 곤란할 때 병원에서 사용되는 O2(산소)와 “웃음가스”로 불리며 마취용으로 치과 의사들이 사용하는 N2O가 있다'", 
        a: ["가연성 가스", "산화성 가스", "부식성 가스", "자연발화성 가스"], 
        c: 1, 
        r: "산화성(조연성) 가스는 연소를 도와 반응을 격렬하게 증가시키는 가스로, 산소(O2)와 아산화질소(N2O, 웃음가스)가 있습니다." 
    },
    { 
        q: "반도체 가스 종류 중 하나에 대한 설명이다. 이 설명에 해당하는 가스군은?\n\n'- 독성 가스 : 성인남자가 1일 8시간 근무시 인체에 해를 끼치지 않는 허용농도(=TLV)가 200ppm 이하인 가스로써 흡입시 신체내의 신진대사를 방해하며 장기 손상을 준다. 대량 누출 시 생명에 영향을 주어 사망 또는 회복하기 어려운 피해를 받게된다. 유해성으로는 화재 및 폭발, 중독, 고 압력으로 주의를 가지고 관리해야 한다. 사용 예로는 CO, Cl2, F2, ClF3, BCl3, SiH4등이 있다.'", 
        a: ["불연성 가스", "산화성 가스", "독성 가스", "자연발화성 가스"], 
        c: 2, 
        r: "독성 가스는 허용 한계 농도가 200ppm 이하인 해로운 가스로서 신진대사를 방해하고 체내 장기에 치명적 손상을 줍니다." 
    },
    { 
        q: "반도체 가스 종류 중 하나에 대한 설명이다. 이 설명에 해당하는 가스군은?\n\n'- 부식성 가스 : 다른 물질과 화학반응을 일으켜 물질 조직을 파괴 시키거나 금속등에 부식을 일으키는 가스로써 접촉시 피부조직을 파괴하며 일반적으로 습기와 접하기 전에는 부식성 성질을 가지고 있지 않다. 주요 부식성가스 사용 예는 Cl2, F2, ClF3, BCl3, BF3이 대표적이다.'", 
        a: ["가연성 가스", "독성 가스", "부식성 가스", "자연발화성 가스"], 
        c: 2, 
        r: "부식성 가스는 조직 파괴 및 금속 부식을 발생시키는 가스로서, 물이나 습기를 접하기 전에는 대개 건조한 상태에선 활성화되지 않는 특성이 있습니다." 
    },
    { 
        q: "반도체 가스 종류 중 하나에 대한 설명이다. 이 설명에 해당하는 가스군은?\n\n'- 자연발화성 가스 : 공기중에 누설되면 별도의 점화원 없이 연소하는 가스로써 누출시 화재 및 폭발의 위험성이 높다. 가스의 농도와 유량에 영향을 받는다. 유해성으로는 화재 및 폭발을 유발하는 가연성과 고 압력을 주의 해야한다. 사용 예로는 SiH4(실란), AsH3(아르신), PH3(포스핀) 등이 있다.'", 
...
const diPool = [
    { 
        q: "다음 설명에 해당하는 DI 시스템 장비는?\n\n'마이크로 필터 : 멤브레인을 통하여 액체에 포함되어 있는 오염물질을 제거하는 것, 마이크로 필터는 0.1um~수십 um를 가지며 낮은 압력에 의한 흐름으로 부터 필터링 된다'", 
    ...
    { 
        q: "다음 설명에 해당하는 DI 시스템 장비는?\n\n'A/C 필터 : 원수중에는 비이온성 용해물질이 함유되고 있다.. 이런 물질이 원수에 혼합되어 있으면 제거 처리하기가 어렵고, 수중의 냄새에 색상의 원인이 되고있는 유기물과 다른 비전해질 현탁물질을 흡착 제거하기 위해 흡착력이 뛰어난 활성탄을 이용한다.'", 
        a: ["마이크로 필터", "A/C 필터", "MBD (mixed bed deionizer)", "MBP (mixed bed polisher)"], 
        c: 1, 
        r: "A/C 필터는 활성탄(Activated Carbon)의 높은 흡착 성능을 통하여 냄새, 색상의 원인인 유기물을 흡착 여과합니다." 
    },
    { 
        q: "다음 설명에 해당하는 DI 시스템 장비는?\n\n'MBD(mixed bed deionizer) : 강산성 양이온 교환수지와 강염기성 음이온 교환수지를 단일탑에 혼합 충진시킨 후 원수중에 함유되어 있는 양이온과 음이온 성분을 완전히 제거하여 순수한 물을 교환 생성하는 장치이다. 또한 혼상식 순수제조장치는 원수가 통과하면서 양이온과 음이온을 여러번 통과시키는 효과를 가져오므로 고순도의 수질을 얻는데 적합하다. 일정용량을 생산한 후 가성 소다(NaOH)와 염산(HCI)으로 재생 반복 사용할 수 있다.'", 
        a: ["마이크로 필터", "A/C 필터", "MBD (mixed bed deionizer)", "MBP (mixed bed polisher)"], 
        c: 2, 
        r: "MBD는 양이온/음이온 수지를 활용해 불순물 이온을 고순도로 제거하며 가성소다와 염산으로 반복 화학 재생하여 사용하는 장치입니다." 
    },
    { 
        q: "다음 설명에 해당하는 DI 시스템 장비는?\n\n'MBP(mixed bed polisher) : MBD에서 처리된 초순수를 다시 한번 양이온과 음이온을 제거하는 공정으로서 내부에는 양이온과 음이온 교환수지가 혼합되어 있으며 순수한 H2O를 생산하며 수지의 재생이 불가능한 비재생형이다. 이 공정을 지나면 18MΩ-cm 이상의 고순도로 상승한다'", 
        a: ["마이크로 필터", "A/C 필터", "MBD (mixed bed deionizer)", "MBP (mixed bed polisher)"], 
        c: 3, 
...
const cleaningPool = [
    { 
        q: "세정공정 화학 용액 중 하나에 대한 설명이다. 이 설명에 해당하는 용액은?\n\n'SPM : 웨이퍼 위에 PR 유기 오염물을 제거'", 
        a: ["SPM", "SC - 1", "SC - 2", "HF"], 
        c: 0, 
        r: "SPM은 황산과 과산화수소 혼합액으로, 유기물 오염과 PR(감광액) 찌꺼기를 세척하는 대표적인 산성 화학용액입니다." 
    },
    { 
        q: "세정공정 화학 용액 중 하나에 대한 설명이다. 이 설명에 해당하는 용액은?\n\n'SC - 1 : 웨이퍼 위에 Particle과 유기 오염물을 제거'", 
        a: ["SPM", "SC - 1", "SC - 2", "HF"], 
        c: 1, 
        r: "SC-1은 암모니아와 과산화수소 용액을 이용해 주로 입자성 파티클과 일부 유기 오염물을 제거해 줍니다." 
    },
    { 
        q: "세정공정 화학 용액 중 하나에 대한 설명이다. 이 설명에 해당하는 용액은?\n\n'SC - 2 : 천이성 금속을 제거'", 
        a: ["SPM", "SC - 1", "SC - 2", "HF"], 
        c: 2, 
        r: "SC-2는 염산과 과산화수소 용액의 결합을 바탕으로 금속 이온을 용해시켜 천이성 금속을 깔끔하게 제거합니다." 
    },
    { 
        q: "세정공정 화학 용액 중 하나에 대한 설명이다. 이 설명에 해당하는 용액은?\n\n'HF : 산화물이나 산화물 내의 금속 오염물을 제거'", 
        a: ["SPM", "SC - 1", "SC - 2", "HF"], 
        c: 3, 
        r: "HF는 실리콘 웨이퍼의 박막 산화층(SiO2)을 깎거나, 산화층 내부에 트랩된 금속 오염물질을 녹여 걷어낼 때 활용합니다." 
    }
];
...
const exposureEquipPool = [
    { 
        q: "다음 설명에 해당하는 노광 장비는 무엇인가?\n\n'Stepper : 248nm∼436nm 파장의 빛을 레티클의 패턴에 조사시켜, 광학 렌즈를 이용 1:2.5, 1:5로 축소하여 패턴을 웨이퍼 위에 노광하는 장비'", 
        a: ["Stepper", "Scanner", "Aligner", "Track"], 
        c: 0, 
        r: "Stepper는 특정 레티클 상을 배율 렌즈로 축소 노광하며, 단계별로(Step-and-repeat) 웨이퍼 전체에 걸쳐 반사시키는 미세 가공 장비입니다." 
    },
    { 
        q: "다음 설명에 해당하는 노광 장비는 무엇인가?\n\n'Scanner : 노광장치에서 반도체 IC 내 미세패턴의 정확한구현을 위해 레티클의한쪽부터 빛을 조사해 나가는 장치.'", 
        a: ["Stepper", "Scanner", "Aligner", "Track"], 
        c: 1, 
        r: "Scanner는 레티클 전체에 빛을 한 번에 다 주는 대신, 위에서 아래로 주사(Scan)하면서 띠 형태로 정밀하게 패턴을 입히는 기계입니다." 
    },
    { 
        q: "다음 설명에 해당하는 노광 장비는 무엇인가?\n\n'Aligner : 간격을 일정간격으로 띄운 상태에서 노광하는 마스크와 감광막을 접촉시킨 상태에서 자외선을 조사시켜 노광하는 장비. 즉 마스크의 상이 1 : 1 비율로 투영하는 장비'", 
        a: ["Stepper", "Scanner", "Aligner", "Track"], 
        c: 2, 
...
const wetEtchPool = [
    { 
        q: "에칭 공정의 구분 중 다음 설명에 해당하는 것은?\n\n'식각 방법에 따른 구분 : Wet etch (습식식각), Dry Etch (건식식각)'", 
        a: ["식각 방법에 따른 구분", "식각 반응에 따른 구분", "식각 형태에 따른 구분", "식각 장비에 따른 구분"], 
        c: 0, 
        r: "식각 방법에 따른 분류는 화학 액체 약품 세정을 주체로 하는 습식(Wet)과 가스 고주파 방전으로 입자를 때리는 건식(Dry)으로 분류합니다." 
    },
    { 
        q: "에칭 공정의 구분 중 다음 설명에 해당하는 것은?\n\n'식각 반응에 따른 구분 : Chemical Etch (화학적 식각), Physical Etch (물리적 식각)'", 
        a: ["식각 방법에 따른 구분", "식각 반응에 따른 구분", "식각 형태에 따른 구분", "식각 장비에 따른 구분"], 
        c: 1, 
        r: "식각 반응에 따른 분류는 식각 가스/액체 원자 자체의 순수 화학 반응에 의존하는 화학(Chemical)식각과, 가속 이온 충돌 에너지를 이용하는 물리(Physical)식각으로 구분합니다." 
    },
    { 
        q: "에칭 공정의 구분 중 다음 설명에 해당하는 것은?\n\n'식각 형태에 따른 구분 : Isotropic Etch (등방성 식각), Anisotropic Etch (이방성 식각)'", 
        a: ["식각 방법에 따른 구분", "식각 반응에 따른 구분", "식각 형태에 따른 구분", "식각 장비에 따른 구분"], 
        c: 2, 
        r: "식각 형태에 따른 분류는 전 방향으로 고르게 깎여 둥근 형상을 띠는 등방성(Isotropic)과 한 방향(주로 수직)으로만 집중적으로 패어 직벽을 형성하는 이방성(Anisotropic)으로 분리합니다." 
    }
];
...
const plasmaPool = [
    { 
        q: "Dry Etch 플라즈마의 발생 원리 중 다음 설명에 해당하는 현상은?\n\n'이온화 (Ionization) : 외부에서 인가된 전계에 의해 전자가 가속되어 가스원자와 충돌, 원자핵에 구속되어 돌던 전자가 충돌에너지를 흡수하여 원자의 구속에서 벗어남'", 
    ...
    { 
        q: "Dry Etch 플라즈마의 발생 원리 중 다음 설명에 해당하는 현상은?\n\n'여기 (Excitation) : 전자들이 다시 가속되어 다른 원자와 충돌하여 제2차, 3차의 이온화 발생, 라디칼 발생'", 
        a: ["이온화 (Ionization)", "여기 (Excitation)", "분해, 재결합 (Dissociation, Recombination)", "에너지방출 (photoemission)"], 
        c: 1, 
        r: "여기(Excitation)는 전자 충돌 충격량이 이온을 형성할 만큼 세지는 않으나, 내부 전자를 높은 외곽 불안정 궤도 에너지 상태로 띄워 올리는 충격 현상입니다." 
    },
    { 
        q: "Dry Etch 플라즈마의 발생 원리 중 다음 설명에 해당하는 현상은?\n\n'분해, 재결합 (Dissociation, Recombination) : 가속된 전자가 가스원자와 충돌하였으나 에너지가 원자핵 구속을 벗어날 만큼 충분하지 못한 경우, 전자가 더 높은 에너지 상태의 다른 궤도로 여기, 라디칼 발생'", 
        a: ["이온화 (Ionization)", "여기 (Excitation)", "분해, 재결합 (Dissociation, Recombination)", "에너지방출 (photoemission)"], 
        c: 2, 
        r: "분해 및 재결합은 가스 결합 분자가 파괴되거나 활성도가 높아져 화학 에칭을 적극 주도하는 라디칼(Radical)을 형성하는 주요 경로입니다." 
    },
    { 
        q: "Dry Etch 플라즈마의 발생 원리 중 다음 설명에 해당하는 현상은?\n\n'에너지방출 (photoemission) : 높은 에너지 상태의 궤도로 여기된 전자가 원래의 궤도로 되돌아가면 그 에너지 차에 해당하는 만큼의 에너지 방출(열에너지 혹은 빛 에너지)'", 
        a: ["이온화 (Ionization)", "여기 (Excitation)", "분해, 재결합 (Dissociation, Recombination)", "에너지방출 (photoemission)"], 
        c: 3, 
        r: "에너지 방출(Photoemission)은 궤도 이탈했던 전자가 본래의 안정한 바닥 상태로 하강 안착하며 여분 잔류의 열이나 고유한 가시광선 파장을 내뿜는 복사 소광 현상입니다." 
    }
];
...
function finishQuiz() {
    ...
    `;
}�고 빠져나가기 때문에 웨이퍼 온도를 측정하고 정밀하게 컨트롤하는 것이 핵심이다.",
            "Furnace annealing과 동일하게 850-1000 °C의 온도에서 약 30분간 서서히 진행하는 열처리 방식이다."
        ], 
        c: 3, 
